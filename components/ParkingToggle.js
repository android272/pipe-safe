...
export function setupParkingToggle(container) {
    if (!container) {
    ...
    `;
        // Add toggle listener
        const toggleInput = container.querySelector('#parking-toggle');
        const toggleContainer = container.querySelector('.parking-toggle-container');
