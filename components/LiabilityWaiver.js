...
export function setupLiabilityWaiver(container, renderApp) {
  ...
  `;
    const acceptButton = container.querySelector('#accept-waiver');
    const declineButton = container.querySelector('#decline-waiver');
